...
7. 原来Jekyll支持很多个博客站点的导入, 今天才发现. 比如[wordpress导入到Jekyll](https://import.jekyllrb.com/docs/wordpress/), 只要一个插件配置好使用就行了, 参考官方[博客迁移](http://import.jekyllrb.com/docs/home/)